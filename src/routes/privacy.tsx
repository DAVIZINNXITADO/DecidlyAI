        ...
        <main className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          ...
          <div className="border-b border-slate-800 pb-10">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-400">
              ...
              utiliza e protege informações quando você utiliza nossa
              plataforma.
            </p>
          ...
          <div className="mt-12 space-y-12">
            ...
            >
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  Fornecer os recursos e funcionalidades da plataforma;
                </li>
            ...
            >
              <p>
                ...
                decisões são utilizadas para disponibilizar as funcionalidades
                da plataforma DecidlyAI.
              </p>

              <p>
                Recomendamos que você evite inserir informações pessoais
                sensíveis ou confidenciais que não sejam necessárias para
                utilizar o serviço.
              </p>
            </PrivacySection>
            ...
            >
              <p>O DecidlyAI não vende suas informações pessoais.</p>
              ...
              <p>
                ...
                necessária para fornecer seus serviços e apoiar o funcionamento
                do DecidlyAI.
              </p>

              <p>
                Também poderemos divulgar informações quando isso for exigido
                pela legislação aplicável ou quando for razoavelmente necessário
                para proteger a segurança, os direitos, os usuários ou o
            ...
            >
              <p>
                Adotamos medidas razoáveis para ajudar a proteger as
                informações processadas pelo DecidlyAI.
              </p>
            ...
            >
              <p>
                Podemos manter determinadas informações enquanto sua conta
                estiver ativa ou pelo período necessário para fornecer nossos
                serviços, manter a segurança, cumprir obrigações legais ou
                resolver possíveis problemas.
              </p>

              <p>
                Os períodos de retenção podem variar conforme o tipo de
                informação e a finalidade para a qual ela é processada.
              </p>
            </PrivacySection>
            ...
            >
              <p>
                Você poderá solicitar informações sobre sua conta ou solicitar
                a exclusão de determinadas informações, conforme os recursos
            ...
            >
              <p>
                ...
                permitir funcionalidades essenciais da plataforma, manter
                sessões de autenticação, melhorar a experiência do usuário e
                compreender aspectos técnicos do funcionamento do serviço.
              </p>
            ...
            >
              ...
              <p>
                Atualmente, esses serviços incluem o Google para autenticação e
                o Supabase para autenticação e infraestrutura de suporte à
                plataforma.
              </p>
            ...
            >
              <p>
                ...
                periodicamente para refletir alterações no DecidlyAI, em nossos
                serviços ou em requisitos legais aplicáveis.
              </p>
