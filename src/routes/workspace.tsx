...
function Workspace() {
  ...
  const startNewConversation =
    useCallback(() => {
      ...
      /*
       * O focus aqui só acontece quando o usuário
       * explicitamente cria uma nova conversa.
       */
      requestAnimationFrame(() => {
  ...
  const sendMessage = useCallback(
    async () => {
      ...
      try {
        ...
        /*
         * IMPORTANTE:
         * não focar o textarea aqui.
         * Assim o teclado não abre novamente.
         */
        setIsLoading(false);
      }
    },
      ...
      <main className="relative z-10 h-[100dvh] min-h-0 overflow-hidden">
        ...
        >
          <div className="relative mx-auto max-w-3xl">
            ...
            <div
              className="bg-[#17101f] px-3 py-2 shadow-2xl"
              style={{
                border: "none",
                outline: "none",
                boxShadow:
