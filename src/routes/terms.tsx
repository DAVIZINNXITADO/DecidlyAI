      ...
      <div className="relative">
        ...
        <main className="mx-auto max-w-4xl px-6 py-16 md:py-24">
          ...
          <div className="mt-12 space-y-12">
            ...
            >
              <p>
                Ao acessar ou utilizar o DecidlyAI, você concorda com estes
                Termos de Uso e com as demais políticas aplicáveis à plataforma.
              </p>
            ...
            >
              <p>
                O DecidlyAI é uma ferramenta de apoio à organização e análise
                de decisões.
              </p>

              <p>
                As informações, sugestões ou análises apresentadas pela
                plataforma não devem ser interpretadas como garantia de
                resultados ou como substituição ao julgamento pessoal do
                usuário.
              </p>
            ...
            >
              <p>
                Algumas funcionalidades do DecidlyAI podem exigir a criação de
                uma conta e a autenticação do usuário.
              </p>

              <p>
                Você é responsável por utilizar sua conta de forma adequada e
                por manter suas informações de acesso protegidas.
              </p>
            ...
            >
              <p>
                O DecidlyAI pode permitir a autenticação por meio de serviços
            ...
            >
              <p>
                Você concorda em utilizar o DecidlyAI de maneira responsável e
            ...
            >
              ...
              <p>
                Recomendamos que você não insira informações pessoais sensíveis
                ou confidenciais que não sejam necessárias para utilizar a
                plataforma.
              </p>
            ...
            >
              ...
              <p>
                O serviço poderá passar por manutenção, atualizações, melhorias
                ou alterações técnicas que podem afetar temporariamente sua
                disponibilidade.
              </p>
            </TermsSection>
            ...
            >
              ...
              <p>
                ...
                descontinuadas quando necessário para melhorar a plataforma ou
                por motivos técnicos, operacionais ou legais.
              </p>
            </TermsSection>
            ...
            >
              ...
              <p>
                Você não pode copiar, reproduzir, modificar ou utilizar
                elementos do DecidlyAI de maneira não autorizada.
              </p>
            </TermsSection>
            ...
            >
              ...
              <p>
                Não garantimos resultados específicos decorrentes da utilização
                da plataforma ou das decisões tomadas pelo usuário.
              </p>

              <p>
                Sempre que necessário, decisões importantes devem ser avaliadas
                com cuidado e, quando apropriado, com o apoio de profissionais
                qualificados.
              </p>
            </TermsSection>
            ...
            >
              <p>
                ...
                quando houver uso indevido, tentativa de comprometer a segurança
                do serviço ou violação destes Termos de Uso.
              </p>
            ...
            >
              <p>
                O tratamento de informações relacionadas à utilização do
                DecidlyAI é explicado em nossa Política de Privacidade.
              </p>
